...
$user_groups_query = "
    SELECT gi.groupID, gi.groupName, gi.meetingTimes, gi.groupDescription, gi.numLimit,
...
<head>
    ...
    <title>My Groups | Academic Clan</title>
                ...
                <?php if ($user_groups_result->num_rows > 0): ?>
                    ...
                    <?php while ($group = $user_groups_result->fetch_assoc()): ?>
                        <div class="group-item">
                            ...
                            <p><strong>Course:</strong> <?php echo htmlspecialchars($group['meetingTimes']); ?></p>
